...
function page() {
  return (
    <div className="relative w-full min-h-[calc(100vh-96px)] flex items-center justify-center bg-linear-to-br from-[#f8fafc] via-[#f1f5f9] to-[#e2e8f0]">
      ...
      <div className="absolute top-1/4 -left-12 w-64 h-64 bg-violet-200 rounded-full mix-blend-multiply opacity-20 filter blur-3xl"></div>
      <div className="absolute bottom-1/4 -right-12 w-64 h-64 bg-blue-200 rounded-full mix-blend-multiply opacity-20 filter blur-3xl"></div>
